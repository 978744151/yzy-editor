...
import { getAllCustomSchema } from '@/packages/utils/custom-utils'
import { getTid } from '@/utils/index.js'

export class CustomTemplatePlugin extends BasePlugin {
...
registerEditorPlugin(CustomTemplatePlugin)
