...
export default class RichTextEditorControlPlugin extends BasePlugin {
  static id = 'RichTextEditorControlPlugin'
  // 关联渲染器名字
  rendererName = 'el-rich-text-editor'
...
registerEditorPlugin(RichTextEditorControlPlugin)
